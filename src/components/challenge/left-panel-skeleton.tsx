  ...
  return (
    <>
      <Tabs defaultValue="description" className="w-full">
        <TabsList className="sticky top-0 grid h-auto w-full grid-cols-4 rounded-none border-b border-zinc-300 bg-background dark:border-zinc-700 dark:bg-muted">
          <TabsTrigger
            value="description"
        ...
        <TabsContent className="flex h-full flex-col space-y-2 p-5" value="comments">
          <div className="flex flex-col space-y-10">
            <div className="prose-invert flex flex-col space-y-2 prose-h3:text-xl">
              <div className="h-4 rounded-lg bg-zinc-300 dark:bg-zinc-700"></div>
              <div className="h-4 rounded-lg bg-zinc-300 dark:bg-zinc-700"></div>
