...
export const FeatureCard = ({
  ...
  return (
    ...
    >
      <motion.div className="group relative w-full overflow-hidden rounded-xl border bg-gradient-to-b from-neutral-50/90 to-neutral-100/90 transition duration-300 hover:border-transparent dark:from-neutral-950/90 dark:to-neutral-800/90">
