  ...
  return (
    <div className={clsx('flex h-[calc(100%-_90px)] flex-col', className)} ref={wrapper}>
      ...
      >
        ...
        >
          <div className="m-auto h-1 w-24 rounded-full bg-zinc-300 group-hover:bg-primary dark:bg-zinc-700 group-hover:dark:bg-primary group-active:bg-primary group-active:bg-primary group-active:bg-primary duration-300" />
        </div>
        <CodeEditor
          options={{
            lineNumbers: 'off',
