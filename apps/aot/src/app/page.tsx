...
export default function Home() {
  return (
    <div className="-mt-14 grid min-h-screen grid-rows-3 place-content-center place-items-center overflow-hidden bg-gradient-to-b from-emerald-400/40 to-transparent to-50% dark:from-emerald-400/40">
