 ...
 *-----------------------------------------------------------*/ define(
  'vs/editor/editor.main.nls',
  {
    ...
    'vs/editor/browser/services/hoverService/hoverWidget': ['Hold {0} key to mouse over'],
    'vs/editor/browser/services/hoverService/updatableHoverWidget': ['Loading...'],
    ...
    'vs/editor/browser/widget/multiDiffEditor/multiDiffEditorWidgetImpl': ['No Changed Files'],
...
[{1}] {2}`,
    ...
    'vs/platform/actions/common/menuService': ["Hide '{0}'", 'Configure Keybinding'],
...
Received: '{1}'.`,
    ...
    'vs/platform/quickinput/browser/quickInputTree': ['Quick Input'],
