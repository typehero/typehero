 ...
 * Version: 5.5.4(9ca6c2e87e266b504a7a6e5f757f639fef7a1c59)
...
define('vs/language/typescript/tsMode', ['require', 'require'], (require) => {
  ...
  var moduleExports = (() => {
      ...
      H = (n, e, t, r) => {
        if ((e && typeof e == 'object') || typeof e == 'function')
          for (let l of ie(e))
            !se.call(n, l) &&
              l !== t &&
              K(n, l, { get: () => e[l], enumerable: !(r = te(e, l)) || r.enumerable });
        return n;
      },
    ...
    i['lib.es2023.intl.d.ts'] = !0;
    i['lib.es5.d.ts'] = !0;
    i['lib.es6.d.ts'] = !0;
    i['lib.esnext.array.d.ts'] = !0;
    ...
    i['lib.esnext.regexp.d.ts'] = !0;
    i['lib.esnext.string.d.ts'] = !0;
    ...
    function U(n, e, t = 0) {
      ...
      if (((r += n.messageText), t++, n.next)) for (let l of n.next) r += U(l, e, t);
      return r;
    }
    function x(n) {
    ...
    var T = class extends k {
        ...
        async _doValidate(t) {
          let r = await this._worker(t.uri);
          ...
          u || l.push(r.getSyntacticDiagnostics(t.uri.toString())),
            c || l.push(r.getSemanticDiagnostics(t.uri.toString())),
            g || l.push(r.getSuggestionDiagnostics(t.uri.toString()));
        ...
        _convertDiagnostics(t, r) {
          let l = r.start || 0,
            ...
            d = [];
          return (
            r.reportsUnnecessary && d.push(s.MarkerTag.Unnecessary),
            r.reportsDeprecated && d.push(s.MarkerTag.Deprecated),
            {
      ...
      C = class n extends k {
        ...
        async resolveCompletionItem(e, t) {
          let r = e,
            ...
            u = r.position,
            c = r.offset,
            o = await (await this._worker(l)).getCompletionEntryDetails(l.toString(), c, r.label);
          return o
            ? {
                uri: l,
                position: u,
...
${Q(r)}`;
    ...
    function Q(n) {
      ...
      if (n.name === 'param' && n.text) {
        let [t, ...r] = n.text;
        (e += `\`${t.text}\``), r.length > 0 && (e += ` \u2014 ${r.map((l) => l.text).join(' ')}`);
      } else
    ...
    var I = class n extends k {
        ...
        async provideSignatureHelp(t, r, l, u) {
          let c = t.uri,
            g = t.getOffsetAt(r),
          ...
          return (
            a.items.forEach((p) => {
              ...
              (f.documentation = { value: x(p.documentation) }),
                (f.label += x(p.prefixDisplayParts)),
                p.parameters.forEach((b, y, W) => {
                  let w = x(b.displayParts),
                    Z = { label: w, documentation: { value: x(b.documentation) } };
                  (f.label += w),
                    f.parameters.push(Z),
                    y < W.length - 1 && (f.label += x(p.separatorDisplayParts));
                }),
                (f.label += x(p.suffixDisplayParts)),
                d.signatures.push(f);
            }),
            { value: d, dispose() {} }
          );
...
` + a
      ...
      F = class extends k {
        ...
        async provideDefinition(t, r, l) {
          ...
          if (
            !o ||
            t.isDisposed() ||
            (await this._libFiles.fetchLibFilesIfNecessary(o.map((d) => s.Uri.parse(d.fileName))),
            t.isDisposed())
          )
            return;
          let a = [];
      ...
      L = class extends k {
        ...
        async provideReferences(t, r, l, u) {
          let c = t.uri,
            g = t.getOffsetAt(r),
            o = await this._worker(c);
          if (t.isDisposed()) return;
          ...
          if (
            !a ||
            t.isDisposed() ||
            (await this._libFiles.fetchLibFilesIfNecessary(a.map((p) => s.Uri.parse(p.fileName))),
            t.isDisposed())
          )
            return;
          let d = [];
      ...
      M = class extends k {
        async provideDocumentSymbols(e, t) {
          let r = e.uri,
            l = await this._worker(r);
          if (e.isDisposed()) return;
          let u = await l.getNavigationTree(r.toString());
...
`,
      ...
      A = class extends S {
        ...
        async provideDocumentRangeFormattingEdits(t, r, l, u) {
          let c = t.uri,
            g = t.getOffsetAt({ lineNumber: r.startLineNumber, column: r.startColumn }),
            o = t.getOffsetAt({ lineNumber: r.endLineNumber, column: r.endColumn }),
            a = await this._worker(c);
          if (t.isDisposed()) return;
          let d = await a.getFormattingEditsForRange(c.toString(), g, o, S._convertOptions(l));
...
`,
        ...
        async provideOnTypeFormattingEdits(e, t, r, l, u) {
          let c = e.uri,
            g = e.getOffsetAt(t),
            o = await this._worker(c);
          if (e.isDisposed()) return;
      ...
      O = class extends S {
        async provideCodeActions(e, t, r, l) {
          let u = e.uri,
            ...
            o = S._convertOptions(e.getOptions()),
            a = r.markers
              .filter((b) => b.code)
              .map((b) => b.code)
              .map(Number),
          ...
          return !p || e.isDisposed()
            ...
            : {
                actions: p
                  ...
                  .map((b) => this._tsCodeFixActionToMonacoCodeAction(e, r, b)),
                dispose: () => {},
              };
        }
        _tsCodeFixActionToMonacoCodeAction(e, t, r) {
          let l = [];
          for (let c of r.changes)
      ...
      E = class extends k {
        ...
        async provideRenameEdits(t, r, l, u) {
          let c = t.uri,
            g = c.toString(),
            o = t.getOffsetAt(r),
            a = await this._worker(c);
    ...
    function X(n, e) {
      ...
      function g() {
        ...
        Y(r),
          o.completionItems && r.push(s.languages.registerCompletionItemProvider(e, new C(u))),
          o.signatureHelp && r.push(s.languages.registerSignatureHelpProvider(e, new I(u))),
          o.hovers && r.push(s.languages.registerHoverProvider(e, new P(u))),
          o.documentHighlights &&
            r.push(s.languages.registerDocumentHighlightProvider(e, new D(u))),
          o.definitions && r.push(s.languages.registerDefinitionProvider(e, new F(c, u))),
          o.references && r.push(s.languages.registerReferenceProvider(e, new L(c, u))),
          o.documentSymbols && r.push(s.languages.registerDocumentSymbolProvider(e, new M(u))),
          o.rename && r.push(s.languages.registerRenameProvider(e, new E(c, u))),
          o.documentRangeFormattingEdits &&
            r.push(s.languages.registerDocumentRangeFormattingEditProvider(e, new A(u))),
          o.onTypeFormattingEdits &&
            r.push(s.languages.registerOnTypeFormattingEditProvider(e, new R(u))),
          o.codeActions && r.push(s.languages.registerCodeActionProvider(e, new O(u))),
          o.inlayHints && r.push(s.languages.registerInlayHintsProvider(e, new N(u))),
          o.diagnostics && r.push(new T(c, n, e, u));
      }
      return g(), t.push(fe(r)), u;
    }
    function fe(n) {
      return { dispose: () => Y(n) };
    }
