...
export function DifficultyTabs({
  ...
  return (
    <div className={cn('hidden w-full px-4 sm:block', className)}>
      <div className="flex w-full flex-wrap gap-2 border-neutral-200 dark:border-neutral-800">
        {difficulties.map((difficulty) => {
          const isSelected = selectedTab === difficulty.tag;
          const difficultyColor =
            DIFFICULTY_COLORS[difficulty.tag as keyof typeof DIFFICULTY_COLORS];
          ...
          return (
            <button
              ...
              className={cn(
                ...
                {
                  [`border-current ${difficultyColor} bg-opacity-10 dark:bg-opacity-20`]:
                    isSelected,
