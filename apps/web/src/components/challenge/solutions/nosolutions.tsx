...
const NoSolutions = ({ setView, loggedInUser, loggedInUserHasSolution }: Props) => {
  return (
      ...
      <p className="flex flex-col items-center gap-2 text-center text-neutral-500 dark:text-zinc-400">
        ...
        >
          ...
          <path
            ...
            fill="#888a"
          />
          <circle cx="190.15351" cy="24.95465" r="20" fill="#888a" />
          <circle cx="190.15351" cy="24.95465" r="12.66462" fill="#444a" />
          <path
          ...
          <path
            ...
            fill="#888a"
          />
          <circle cx="433.63626" cy="105.17383" r="20" fill="#888a" />
          <circle cx="433.63626" cy="105.17383" r="12.18187" fill="#444a" />
        </svg>
        No solutions yet, <br />
