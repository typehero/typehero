        ...
        <div className="flex flex-col items-center justify-center gap-16">
          <div className="mt-1 flex flex-col gap-3 px-4 text-center sm:px-0">
            <a
              ...
              href="#features"
            >
              <div className="rounded-full group relative duration-300 hover:pr-9 overflow-hidden bg-white/80 px-3 py-1 dark:bg-black/80">
                <span className="bg-gradient-to-r from-[#31bdc6] to-[#3178c6] bg-clip-text text-transparent">
                  ...
                  many features, wow <Image className="absolute duration-300 translate-y-7 group-hover:translate-y-0 -bottom-1 right-1" alt="doge smile" height="28" width="28" src={DogeSmile} />
                </span>
              </div>
            </a>
