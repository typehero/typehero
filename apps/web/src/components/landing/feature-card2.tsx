    ...
    >
      ...
      >
        <div className="mx-10 my-10 min-h-[450px] w-full">
          ...
          {mounted ? (
            <div className="flex absolute w-[100%] inset-0 top-[30%] left-[37px] flex-col gap-3 pt-4">
