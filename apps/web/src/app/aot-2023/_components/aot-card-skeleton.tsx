...
export function AOTCardSkeleton() {
  return (
    <div className="container flex flex-col items-center gap-5 pb-8 md:gap-10 md:py-5">
      ...
      {/*Cards */}
      <div className="+ 8rem)] md:-mx-16 grid w-[calc(100% grid-cols-[repeat(1,240px)] justify-center gap-4 sm:px-8 md:grid-cols-[repeat(3,240px)] md:px-0 lg:mx-0 lg:w-full xl:grid-cols-[repeat(4,240px)] 2xl:gap-8">
