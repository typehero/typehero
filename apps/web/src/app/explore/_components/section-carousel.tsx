...
export function ExploreCarousel({ challenges }: Props) {
  ...
  return (
    ...
    >
      ...
      <button
        className="bg-background absolute -right-5 top-1/2 hidden -translate-y-1/2 rounded-[5rem] p-4 pl-1 duration-300 active:scale-95 sm:block focus:outline-none focus-visible:ring-2"
        id="slideRight"
      >
        <ChevronRight className="h-4 w-4" />
      </button>
      <button
        className="bg-background absolute -left-5 top-1/2 hidden -translate-y-1/2 rounded-[5rem] p-4 pr-1 duration-300 active:scale-95 sm:block focus:outline-none focus-visible:ring-2"
        id="slideLeft"
      >
