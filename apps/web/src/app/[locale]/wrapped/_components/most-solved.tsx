import { Calendar, Check, CheckCheck } from '@repo/ui/icons';
import { motion, type Variants } from 'framer-motion';

export function MostSolved() {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-between gap-2 rounded-3xl bg-gradient-to-l from-green-100 to-30% dark:from-green-950">
      <div className="container flex flex-col-reverse items-center justify-between gap-4 sm:flex-row-reverse">
        ...
        <p className="mb-10 text-4xl font-bold text-green-950 dark:text-green-50 sm:mx-[-130px] sm:mb-0 sm:-rotate-90 sm:text-6xl">
          MOST SOLVED
        </p>
      </div>
    </div>
