...
export function MostLoved() {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-between gap-2 rounded-3xl bg-gradient-to-r from-red-100 to-30% dark:from-red-950">
      <div className="container flex flex-col-reverse items-center justify-between gap-4 sm:flex-row">
        ...
        <p className="mb-10 text-4xl font-bold text-red-950 dark:text-red-50 sm:mx-[-130px] sm:mb-0 sm:rotate-90 sm:text-6xl">
          MOST LOVED
        </p>
      </div>
    </div>
