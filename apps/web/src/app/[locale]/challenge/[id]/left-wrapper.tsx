...
export function LeftWrapper({ challenge, track, children, expandPanel, isDesktop }: Props) {
  ...
  useEffect(() => {
    ...
    const handleResize = (entries: ResizeObserverEntry[]) => {
      for (const entry of entries) {
        ...
        const isMobileCollapsed = !isDesktopRef.current && entry.contentRect.height <= 44;
  ...
  const isTrackEnabled = featureFlags?.enableInChallengeTrack;

  const isTrackVisible = isTrackEnabled && (!isCollapsed || isDesktop);
      ...
      >
        ...
        >
          ...
          <TabsTrigger
            ...
            onClick={() => {
              router.push(`/challenge/${challenge.id}/solutions`);
              expandPanel();
            }}
            value="solutions"
          >
          ...
          <TabsTrigger
            ...
            onClick={() => {
              router.push(`/challenge/${challenge.id}/submissions`);
              expandPanel();
            }}
            value="submissions"
          >
