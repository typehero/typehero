...
export default function Page() {
  return (
    <div className="container prose dark:prose-invert py-10 justify-center">
      ...
      <p>
        By accessing this Website, accessible from https://typehero.dev, you are agreeing to be
      ...
      <p>
        Permission is granted to temporarily download one copy of the materials on Typehero's
      ...
      <ul>
        ...
        <li>attempt to reverse engineer any software contained on Typehero's Website;</li>
      ...
      <p>
        This will let Typehero to terminate upon violations of any of these restrictions. Upon
      ...
      <p>
        All the materials on Typehero's Website are provided "as is". Typehero makes no warranties,
        may it be expressed or implied, therefore negates all other warranties. Furthermore,
        Typehero does not make any representations concerning the accuracy or reliability of the use
      ...
      <p>
        Typehero or its suppliers will not be hold accountable for any damages that will arise with
        the use or inability to use the materials on Typehero's Website, even if Typehero or an
      ...
      <p>
        The materials appearing on Typehero's Website may include technical, typographical, or
        photographic errors. Typehero will not promise that any of the materials in this Website are
        accurate, complete, or current. Typehero may change the materials contained on its Website
        at any time without notice. Typehero does not make any commitment to update the materials.
      </p>

      <h2>6. Links</h2>

      <p>
        Typehero has not reviewed all of the sites linked to its Website and is not responsible for
        the contents of any such linked site. The presence of any link does not imply endorsement by
        Typehero of the site. The use of any linked website is at the user's own risk.
      </p>

      <h2>7. Site Terms of Use Modifications</h2>

      <p>
        Typehero may revise these Terms of Use for its Website at any time without prior notice. By
      ...
      <p>
        Any claim related to Typehero's Website shall be governed by the laws of af without regards
