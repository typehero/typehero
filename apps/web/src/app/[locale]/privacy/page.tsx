...
export default function Page() {
  return (
    <div className="prose dark:prose-invert container justify-center py-10">
      ...
      <p>
        At Tyephero, accessible from https://typehero.dev, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of information that is
        collected and recorded by Tyephero and how we use it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in Tyephero. This
      ...
      <p>
        Tyephero follows a standard procedure of using log files. These files log visitors when they
      ...
      <p>
        Like any other website, Tyephero uses "cookies". These cookies are used to store information
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on Tyephero,
      ...
      <p>
        Note that Tyephero has no access to or control over these cookies that are used by
      ...
      <p>
        Tyephero's Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      <p>
        Tyephero does not knowingly collect any Personal Identifiable Information from children
