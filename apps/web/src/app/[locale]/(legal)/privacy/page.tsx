  ...
  return (
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        ...
        <p>
          At Tyephero, accessible from https://typehero.dev, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by Tyephero and how we use it.
        </p>
        ...
        <p>
          Tyephero follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, Tyephero uses "cookies". These cookies are used to store
        ...
        <p>
          ...
          Tyephero, which are sent directly to users' browser. They automatically receive your IP
