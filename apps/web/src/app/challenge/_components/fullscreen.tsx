...
export function FullscreenButton() {
  const toggleFullscreen = useLayoutSettingsStore((state) => state.toggleFullscreen);

  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <button className="focus:outline-none focus-visible:ring-2" onClick={toggleFullscreen}>
