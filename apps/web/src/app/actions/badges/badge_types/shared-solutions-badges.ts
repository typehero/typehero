...
import type { DifficultyBadges } from '~/app/actions/badges/badge_types/difficulty-badges';
import type { AotBadges } from '~/app/actions/badges/badge_types/advent-badges';
