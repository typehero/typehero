...
const EnrolledAndCompletedBadge = ({ text = 'Enrolled' }: { text?: string }) => (
  <div
    className={clsx(
      'absolute top-0 left-0 z-10 rounded-br-3xl bg-[#3078c5] px-5 py-1.5 font-bold text-background text-sm dark:bg-blue-400',
        ...
        className={clsx(
          ...
          isCompleted
            ...
            : isEnrolled
              ...
              : 'group-hover:border-neutral-400 group-hover:shadow-xl group-focus:border-neutral-500 dark:group-hover:border-border dark:group-hover:shadow dark:group-hover:shadow-neutral-400/70',
        )}
      >
        <div className="-bottom-12 -left-4 -translate-x-1/4 absolute w-full translate-y-1/4 rotate-[30deg]">
          <div
            className={clsx(
              '-ml-4 group-hover:-translate-y-1 h-12 w-full border-t bg-gradient-to-r to-white duration-500 dark:to-[#09090b]',
              isEnrolled
          ...
          <div
            className={clsx(
              '-ml-8 group-hover:-translate-y-5 h-12 w-full border-t bg-gradient-to-r to-white duration-500 dark:to-[#09090b]',
              isEnrolled
                ? 'border-blue-500/50 from-blue-100 dark:border-blue-400/50 dark:from-[#2b4567]'
                : 'border-neutral-500/50 from-neutral-100 dark:border-neutral-700/50 dark:from-neutral-900 dark:group-hover:brightness-150',
            )}
          ...
          <div
            className={clsx(
              '-ml-12 group-hover:-translate-y-8 h-12 w-full border-t bg-gradient-to-r to-white duration-500 dark:to-[#09090b]',
              isEnrolled
                ? 'border-blue-500/50 from-blue-100 dark:border-blue-400/50 dark:from-[#2b4567]'
                : 'border-neutral-500/50 from-neutral-100 dark:border-neutral-700/50 dark:from-neutral-900 dark:group-hover:brightness-150',
            )}
          ...
          <div
            className={clsx(
              '-ml-16 group-hover:-translate-y-12 h-12 w-full border-t bg-gradient-to-r to-white duration-500 dark:to-[#09090b]',
              isEnrolled
                ? 'border-blue-500/50 from-blue-100 dark:border-blue-400/50 dark:from-[#2b4567]'
                : 'border-neutral-500/50 from-neutral-100 dark:border-neutral-700/50 dark:from-neutral-900 dark:group-hover:brightness-150',
            )}
