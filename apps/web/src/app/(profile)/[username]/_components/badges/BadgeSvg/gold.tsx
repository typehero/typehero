export function Gold({ className, shortName }: { className?: string; shortName: string }) {
  return (
    <>
      <svg
        className={className}
      ...
      >
        ...
        <g mask="url(#mask0_16_56)">
          <rect width="250" height="250" fill="url(#paint0_linear_16_56)" />
          <path
