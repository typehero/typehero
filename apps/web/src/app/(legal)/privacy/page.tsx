  ...
  return (
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        ...
        <p>
          Typehero ("we”, “us”, or “our") provides this Privacy Policy to inform you of our policies
          and procedures regarding the collection, use and disclosure of personal information we may
          receive from users of our website (“Site”), accessible from https://typehero.dev, and any
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in Typehero. This
        ...
        <p>
          Typehero follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, Typehero uses "cookies". These cookies are used to store
        ...
        <p>
          ...
          Typehero, which are sent directly to users' browser. They automatically receive your IP
        ...
        <p>
          Note that Typehero has no access to or control over these cookies that are used by
        ...
        <p>
          Typehero's Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          ...
          <a href="mailto:typeheroapp@gmail.com">typeheroapp@gmail.com</a>.
        </p>
        ...
        <p>
          Typehero does not knowingly collect any Personal Identifiable Information from children
        ...
        <p>
          ...
          practices, at <a href="mailto:typeheroapp@gmail.com">typeheroapp@gmail.com</a>
        </p>
