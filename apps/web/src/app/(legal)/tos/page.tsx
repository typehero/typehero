  ...
  return (
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        ...
        <p>
          All the materials on Typehero's Website are provided "as is". Typehero makes no
          warranties, may it be expressed or implied, therefore negates all other warranties.
          Furthermore, Typehero does not make any representations concerning the accuracy or
        ...
        <p>
          Typehero or its suppliers will not be hold accountable for any damages that will arise
          with the use or inability to use the materials on Typehero's Website, even if Typehero or
        ...
        <p>
          ...
          photographic errors. Typehero will not promise that any of the materials in this Website
          are accurate, complete, or current. Typehero may change the materials contained on its
          Website at any time without notice. Typehero does not make any commitment to update the
          materials.
        </p>
        ...
        <p>
          Typehero has not reviewed all of the sites linked to its Website and is not responsible
          for the contents of any such linked site. The presence of any link does not imply
          endorsement by Typehero of the site. The use of any linked website is at the user's own
          risk.
        </p>
        ...
        <p>
          Typehero may revise these Terms of Use for its Website at any time without prior notice.
        ...
        <p>
          Any claim related to Typehero's Website shall be governed by the laws of af without
